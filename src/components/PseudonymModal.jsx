        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full bg-slate-950 border-2 border-slate-800 focus:border-emerald-500 rounded-2xl px-5 py-3.5 text-white font-bold text-lg text-center outline-none transition-colors placeholder:text-slate-600"
              autoFocus
            />
            {error && (
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-black text-sm uppercase tracking-widest rounded-2xl shadow-lg shadow-emerald-900/50 transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:from-emerald-600"
          >

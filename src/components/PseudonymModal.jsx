...
export function PseudonymModal({ onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 z-[200] flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-slate-200 dark:bg-[#0F172A] border border-emerald-500/50 rounded-2xl md:rounded-3xl p-5 md:p-8 max-w-sm w-[95%] shadow-[0_0_60px_rgba(16,185,129,0.3)] relative overflow-y-auto max-h-[90vh]">
        {/* Glow decor */}
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full bg-slate-300 dark:bg-slate-950 border-2 border-slate-300 dark:border-slate-800 focus:border-emerald-500 rounded-2xl px-5 py-3.5 text-slate-800 dark:text-white font-bold text-lg text-center outline-none transition-colors placeholder:text-slate-600"
              autoFocus
            />
            {error && (

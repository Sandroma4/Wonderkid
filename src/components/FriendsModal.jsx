            ...
            <div>
              ...
              <div className="space-y-3">
                {searchResults.map(res => (
                  <div key={res.id} className="bg-white/90 dark:bg-slate-800/80 p-3 rounded-xl border border-slate-300 dark:border-slate-700 flex justify-between items-center">

        ...
        >
          ...
          <div className="max-w-5xl mx-auto space-y-1.5 md:space-y-4 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              {/* ONGLET : MARCHÉ - visible sur mobile uniquement, contenu intégré dans Carrière sur desktop */}
              <div className={`${activeMobileTab !== 'marche' ? 'hidden' : 'flex'} md:hidden flex-col space-y-4`}>

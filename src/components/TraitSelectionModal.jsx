...
export const TraitSelectionModal = ({ onSelect }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-300/90 dark:bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-slate-50 dark:bg-slate-900 border border-slate-300/80 dark:border-slate-700/50 rounded-2xl md:rounded-3xl p-4 md:p-6 max-w-2xl w-[95%] shadow-2xl relative overflow-y-auto max-h-[90vh]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {traits.map((trait) => (
            <button
              ...
              className="flex flex-col items-center p-6 bg-slate-100/50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-2xl hover:bg-slate-200 dark:hover:bg-slate-800 hover:border-amber-500/50 transition-all group text-left relative overflow-hidden"
            >

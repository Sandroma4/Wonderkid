  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0F172A] flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-12 left-4 md:top-6 md:left-6 z-20">
        <button
          onClick={toggleTheme}
          className="bg-slate-50/90 dark:bg-slate-800/80 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-900 dark:text-white p-2.5 md:p-3 rounded-full shadow-lg border border-slate-300 dark:border-slate-700 transition-all hover:scale-110 flex items-center justify-center w-12 h-12"
      ...
      <div className="absolute top-12 right-4 md:top-6 md:right-6 z-20 flex items-center gap-2">
        ...
        {user && (
          <button 
            ...
            className="bg-slate-50/90 dark:bg-slate-800/80 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-900 dark:text-white p-2.5 md:p-3 rounded-full shadow-lg border border-slate-300 dark:border-slate-700 transition-all hover:scale-110"
          >
            👥
          </button>
        )}
        ...
        <button 
          ...
          className="bg-slate-50/90 dark:bg-slate-800/80 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-900 dark:text-white p-2.5 md:p-3 rounded-full shadow-lg border border-slate-300 dark:border-slate-700 transition-all hover:rotate-90"
        >
          ⚙️
        </button>
      </div>
      ...
      {incomingInvite && (
        <div className="fixed top-24 right-4 z-50 bg-white dark:bg-slate-900 border border-emerald-500 rounded-xl p-4 shadow-2xl animate-bounce-in max-w-sm w-full md:w-auto">
          ...
          <p className="text-slate-900 dark:text-white text-sm mb-4"><span className="font-bold text-amber-600 dark:text-amber-400">{incomingInvite.senderName}</span> vous invite à jouer en 1v1 !</p>
          <div className="flex gap-2">
            <button 
              onClick={() => { playSound('click'); onJoinInvite(incomingInvite.roomId); setIncomingInvite(null); }}
              className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-slate-900 dark:text-white text-xs font-bold py-2 rounded-lg transition-colors"
            >
              Rejoindre
            </button>
            <button 
              onClick={() => { playSound('click'); setIncomingInvite(null); }}
              className="flex-1 bg-slate-200 dark:bg-slate-700 hover:bg-rose-500 text-slate-900 dark:text-white text-xs font-bold py-2 rounded-lg transition-colors"
            >
              Refuser
            </button>
          </div>
      ...
      {/* Settings Modal */}
      {showSettings && (
        <div className="fixed inset-0 bg-slate-200/90 dark:bg-black/80 z-50 flex items-center justify-center p-4">
            ...
            {!user ? (
              <div className="space-y-4">
                ...
                <input
                  ...
                  className="w-full bg-slate-100 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-4 py-3 text-slate-900 dark:text-white font-bold focus:border-emerald-400 outline-none text-sm text-center"
                />
                <input
                  type="password"
                  value={password}
                ...
                <button
                  ...
                  className="w-full py-3 bg-emerald-600 hover:bg-emerald-500 text-slate-900 dark:text-white font-bold rounded-xl text-sm uppercase tracking-wider transition-colors shadow-lg"
                >
                  {isLoginMode ? 'Se Connecter' : 'Créer un Compte'}
                </button>
                <button
                  onClick={() => setIsLoginMode(!isLoginMode)}
                  className="w-full text-xs text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white underline mt-2"
                >
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center mt-4 md:-mt-32">
        ...
        <div className="w-full space-y-4 animate-[slide-up_0.8s_ease-out]">
          ...
          {showPlayOptions ? (
            <div className="space-y-4 animate-[fade-in_0.3s_ease-out]">
              <button 
                ...
                className="w-full relative group overflow-hidden rounded-2xl bg-slate-50/90 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 p-3 transition-all duration-300 hover:bg-slate-300 dark:hover:bg-slate-700 active:scale-95 flex items-center gap-2 justify-center"
              >
              ...
              >
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Nouvelle Carrière</span>
                  </div>
              ...
              {hasSave && (
                ...
                >
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-3">
                      <span className="text-xl md:text-2xl">⏳</span>
                      <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Continuer la Carrière</span>
                    </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Course à la Carrière (1v1)</span>
                    </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-3">
                      <span className="text-xl md:text-2xl">🤝</span>
                      <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Frères d'Armes (Coop)</span>
                    </div>
            ...
            <>
              ...
              >
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div className="flex items-center gap-3">
                    <span className="text-xl md:text-2xl">🎮</span>
                    <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Jouer</span>
                  </div>
                  <span className="text-emerald-600 dark:text-emerald-300 group-hover:translate-x-1 transition-transform">➔</span>
                </div>
              </button>
          ...
          <button 
            ...
            className="w-full relative group overflow-hidden rounded-2xl bg-slate-50/90 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 p-4 transition-all duration-300 hover:scale-[1.02] hover:bg-slate-300 dark:hover:bg-slate-700 hover:border-amber-500/50 hover:shadow-[0_0_20px_rgba(245,158,11,0.2)] active:scale-95"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-xl md:text-2xl">🌍</span>
                <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Classement Mondial</span>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="heading-typography text-slate-900 dark:text-white font-bold text-lg tracking-wide uppercase">Succès</span>
              </div>
              <span className="text-slate-600 dark:text-slate-400 group-hover:translate-x-1 transition-transform">➔</span>
            </div>
          </button>
          ...
          <button 
            ...
            className="w-full relative group overflow-hidden rounded-2xl bg-slate-50/90 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 p-3 md:p-4 transition-all duration-300 hover:scale-[1.02] hover:bg-slate-300 dark:hover:bg-slate-700 hover:border-slate-400 dark:hover:border-slate-500 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] active:scale-95"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-xl md:text-2xl">🏆</span>
                <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Palmarès Global</span>
              </div>
              <span className="text-slate-600 dark:text-slate-400 group-hover:translate-x-1 transition-transform">➔</span>
            </div>
          </button>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-xl md:text-2xl">🎴</span>
                <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Hall of Fame</span>
              </div>
              <span className="text-slate-600 dark:text-slate-400 group-hover:translate-x-1 transition-transform">➔</span>
            </div>
          </button>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-xl md:text-2xl">📖</span>
                <span className="heading-typography text-slate-900 dark:text-white font-bold text-base md:text-lg tracking-wide uppercase">Historique des Carrières</span>
              </div>
              <span className="text-slate-600 dark:text-slate-400 group-hover:translate-x-1 transition-transform">➔</span>
            </div>
          </button>

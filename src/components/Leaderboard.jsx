...
export const Leaderboard = ({ onBack }) => {
  ...
  return (
    <div className="h-[100dvh] bg-emerald-200 dark:bg-[#0F172A] p-3 md:p-6 text-slate-700 dark:text-slate-200 relative overflow-y-auto font-sans flex flex-col items-center">

  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0F172A] p-3 md:p-6 text-slate-800 dark:text-slate-200 relative overflow-hidden font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        <div className="bg-white/80 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-2xl md:rounded-3xl p-3 md:p-6 shadow-2xl backdrop-blur-sm min-h-[60vh]">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400 font-semibold text-lg">Aucun score enregistré pour le moment.</p>
                  ...
                  <div key={entry.id} className={`${bgClass} rounded-xl md:rounded-2xl p-3 md:p-4 flex items-center justify-between transition-colors`}>
                    <div className="flex items-center gap-2 md:gap-4 overflow-hidden">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[9px] md:text-xs text-slate-600 dark:text-slate-400 font-medium uppercase tracking-wider flex items-center gap-1 md:gap-2 truncate">

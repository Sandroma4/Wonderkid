...
export const Leaderboard = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-200 dark:bg-[#0F172A] p-3 md:p-6 text-slate-700 dark:text-slate-200 relative overflow-hidden font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        <div className="bg-slate-100/90 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-2xl md:rounded-3xl p-3 md:p-6 shadow-2xl backdrop-blur-sm min-h-[60vh]">
          {loading ? (
            ...
            <div className="space-y-3">
              {scores.map((entry, index) => {
                ...
                let bgClass = "bg-slate-300/50 dark:bg-slate-700/50 hover:bg-slate-300 dark:hover:bg-slate-700";
                    ...
                    <div className="flex items-center gap-2 md:gap-4 overflow-hidden">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1 md:gap-2 truncate">
                          ...
                          {entry.nationality && (
                            <span className="text-[9px] md:text-[10px] bg-slate-100 dark:bg-slate-800 px-1 md:px-1.5 py-0.5 rounded border border-slate-300 dark:border-slate-700 shrink-0">{entry.nationality}</span>
                          )}
                        </div>

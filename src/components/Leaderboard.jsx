...
export const Leaderboard = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] p-3 md:p-6 text-slate-200 relative overflow-hidden font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        <div className="bg-slate-800/80 border border-slate-700 rounded-2xl md:rounded-3xl p-3 md:p-6 shadow-2xl backdrop-blur-sm min-h-[60vh]">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <p className="text-slate-400 font-semibold text-lg">Aucun score enregistré pour le moment.</p>
              <p className="text-slate-500 text-sm mt-2">Termine une carrière en étant connecté pour inaugurer le classement !</p>
            </div>
          ) : (
                ...
                return (
                  <div key={entry.id} className={`${bgClass} rounded-xl md:rounded-2xl p-3 md:p-4 flex items-center justify-between transition-colors`}>
                    ...
                    <div className="text-right shrink-0 ml-2">
                      <p className="text-[9px] md:text-xs text-slate-500 uppercase font-bold tracking-widest mb-0.5">Score</p>

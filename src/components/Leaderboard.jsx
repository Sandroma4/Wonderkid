...
export const Leaderboard = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-emerald-300 dark:bg-[#0F172A] p-3 md:p-6 text-slate-700 dark:text-slate-200 relative overflow-hidden font-sans flex flex-col items-center">

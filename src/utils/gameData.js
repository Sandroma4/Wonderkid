...
export const FIRST_NAMES_MALE = {
  FR: ['Hugo', 'Kylian', 'Antoine', 'Olivier', 'Raphaël', 'Lucas', 'Théo', 'Benjamin', 'Aurélien', 'Eduardo', 'Jules', 'Ousmane', 'Kingsley', 'Marcus', 'Adrien', 'Dayot', 'William', 'Ibrahima', 'Youssouf', "N'Golo", 'Paul', 'Karim', 'Zinedine', 'Thierry', 'Laurent', 'Didier', 'Marcel', 'Jean', 'Pierre', 'Mathéo', 'Enzo', 'Nathan', 'Tom', 'Louis', 'Gabriel', 'Arthur', 'Jules', 'Maël', 'Liam', 'Ethan'],
  EN: ['Harry', 'Jude', 'Phil', 'Bukayo', 'Declan', 'John', 'Kyle', 'Luke', 'Trent', 'Jordan', 'Marcus', 'Jack', 'Mason', 'Raheem', 'Kieran', 'Ben', 'Aaron', 'Conor', 'Cole', 'Ollie', 'Wayne', 'David', 'Steven', 'Frank', 'Paul', 'Rio', 'Gary', 'Ashley', 'Joe', 'James', 'Oliver', 'George', 'William', 'Charlie', 'Thomas', 'Henry', 'Arthur', 'Leo', 'Oscar', 'Noah'],
  ES: ['Pedri', 'Gavi', 'Lamine', 'Rodri', 'Alvaro', 'Dani', 'Aymeric', 'Pau', 'Nico', 'Mikel', 'Unai', 'David', 'Sergio', 'Isco', 'Andrés', 'Xavi', 'Iker', 'Fernando', 'Carles', 'Gerard', 'Raúl', 'Jesús', 'José', 'Juan', 'Antonio', 'Francisco', 'Manuel', 'Javier', 'Alejandro', 'Carlos', 'Diego', 'Jorge', 'Mario', 'Pablo', 'Adrián', 'Hugo', 'Martín', 'Lucas', 'Mateo', 'Leo'],
  IT: ['Gianluigi', 'Federico', 'Nicolo', 'Alessandro', 'Ciro', 'Lorenzo', 'Marco', 'Francesco', 'Leonardo', 'Giovanni', 'Andrea', 'Giorgio', 'Giacomo', 'Mattia', 'Matteo', 'Riccardo', 'Emanuele', 'Domenico', 'Vincenzo', 'Antonio', 'Roberto', 'Paolo', 'Christian', 'Stefano', 'Luigi', 'Pietro', 'Davide', 'Filippo', 'Tommaso', 'Edoardo', 'Samuele', 'Diego', 'Alessio', 'Gabriele', 'Christian', 'Daniele', 'Massimo', 'Angelo', 'Carmine', 'Rosario'],
  DE: ['Manuel', 'Thomas', 'Toni', 'Joshua', 'Jamal', 'Leroy', 'Kai', 'Ilkay', 'Serge', 'Leon', 'Florian', 'Antonio', 'Mats', 'Bastian', 'Philipp', 'Lukas', 'Miroslav', 'Michael', 'Oliver', 'Karl', 'Hans', 'Jürgen', 'Dieter', 'Klaus', 'Uwe', 'Jens', 'Stefan', 'Andreas', 'Christian', 'Markus', 'Maximilian', 'Alexander', 'Paul', 'Elias', 'Ben', 'Luis', 'Felix', 'Leon', 'Noah', 'Finn'],
  BR: ['Neymar', 'Vinícius', 'Rodrygo', 'Alisson', 'Ederson', 'Casemiro', 'Marquinhos', 'Thiago', 'Richarlison', 'Gabriel', 'Lucas', 'Raphinha', 'Antony', 'Bruno', 'Ronaldo', 'Ronaldinho', 'Romário', 'Cafu', 'Roberto', 'Pelé', 'Arthur', 'Pedro', 'João', 'Miguel', 'Davi', 'Bernardo', 'Heitor', 'Rafael', 'Guilherme', 'Gustavo', 'Felipe', 'Matheus', 'Enzo', 'Nicolas', 'Daniel', 'Carlos', 'Eduardo', 'Diego', 'Alexandre', 'Marcelo'],
  AR: ['Lionel', 'Angel', 'Emiliano', 'Lautaro', 'Julian', 'Enzo', 'Alexis', 'Rodrigo', 'Cristian', 'Nicolas', 'Nahuel', 'Gonzalo', 'Sergio', 'Diego', 'Javier', 'Juan', 'Carlos', 'Pablo', 'Matias', 'Facundo', 'Bautista', 'Thiago', 'Mateo', 'Benjamín', 'Joaquín', 'Tomás', 'Santino', 'Valentino', 'Ignacio', 'Felipe', 'Lucas', 'Martín', 'Marcos', 'Franco', 'Ezequiel', 'Maximiliano', 'Sebastián', 'Alejandro', 'Marcelo', 'Gaston'],
  NL: ['Virgil', 'Frenkie', 'Matthijs', 'Cody', 'Memphis', 'Denzel', 'Nathan', 'Xavi', 'Teun', 'Stefan', 'Daley', 'Georginio', 'Jurriën', 'Ruud', 'Robin', 'Wesley', 'Arjen', 'Dennis', 'Marco', 'Johan', 'Sem', 'Luuk', 'Daan', 'Bram', 'Thijs', 'Milan', 'Lars', 'Finn', 'Levi', 'Jesse', 'Sven', 'Tim', 'Ruben', 'Nils', 'Pim', 'Bas', 'Casper', 'Stijn', 'Jeroen', 'Koen'],
  PT: ['Cristiano', 'Bruno', 'Bernardo', 'Ruben', 'Joao', 'Diogo', 'Pepe', 'Rafael', 'Nuno', 'Gonçalo', 'Vitinha', 'Pedro', 'Francisco', 'António', 'Rui', 'Luis', 'Deco', 'Eusébio', 'Ricardo', 'Tiago', 'Tomás', 'Martim', 'Rodrigo', 'Afonso', 'Duarte', 'Miguel', 'Gabriel', 'Guilherme', 'Simão', 'Henrique', 'José', 'Manuel', 'Carlos', 'Jorge', 'Paulo', 'Fernando', 'Mário', 'André', 'Hugo', 'Daniel'],
  US: ['Christian', 'Weston', 'Tyler', 'Gio', 'Timothy', 'Sergiño', 'Matt', 'Antonee', 'Yunus', 'Folarin', 'Clint', 'Landon', 'Tim', 'Michael', 'Brian', 'Brad', 'John', 'James', 'William', 'Robert', 'David', 'Richard', 'Joseph', 'Charles', 'Thomas', 'Christopher', 'Daniel', 'Matthew', 'Anthony', 'Mark', 'Donald', 'Steven', 'Paul', 'Andrew', 'Kenneth', 'Joshua', 'Kevin', 'Brian', 'George', 'Edward'],
  JP: ['Takefusa', 'Kaoru', 'Wataru', 'Hidemasa', 'Daichi', 'Takehiro', 'Ritsu', 'Junya', 'Ao', 'Takumi', 'Ko Itakura', 'Yuto', 'Maya', 'Shinji', 'Keisuke', 'Hidetoshi', 'Kazuyoshi', 'Shunsuke', 'Makoto', 'Eiji', 'Haruto', 'Yuto', 'Sota', 'Yuki', 'Hayato', 'Ren', 'Minato', 'Hiroto', 'Sora', 'Riku', 'Kaito', 'Sho', 'Taiga', 'Itsuki', 'Kenji', 'Taro', 'Ichiro', 'Jiro', 'Saburo', 'Shiro'],
  SE: ['Zlatan', 'Alexander', 'Emil', 'Victor', 'Dejan', 'Jesper', 'Mattias', 'Robin', 'Sebastian', 'Carl', 'Henrik', 'Fredrik', 'Johan', 'Anders', 'Mikael', 'Daniel', 'Per', 'Karl', 'Erik', 'Lars', 'Olof', 'Gunnar', 'Nils', 'Sven', 'Björn', 'Magnus', 'Oskar', 'William', 'Lucas', 'Liam', 'Elias', 'Hugo', 'Oliver', 'Theo', 'Nils', 'Isak', 'Arvid', 'August', 'Albin', 'Ludvig'],
  NO: ['Erling', 'Martin', 'Alexander', 'Sander', 'Kristoffer', 'Jens', 'Leo', 'Patrick', 'Mathias', 'Fredrik', 'Ole', 'Tore', 'Henning', 'John', 'Brede', 'Kjetil', 'Jan', 'Erik', 'Bjørn', 'Lars', 'Kjell', 'Svein', 'Knut', 'Arne', 'Geir', 'Morten', 'Rune', 'Terje', 'Odd', 'Roar', 'Jakob', 'Emil', 'Noah', 'Oliver', 'William', 'Filip', 'Aksel', 'Henrik', 'Oskar', 'Elias'],
  DK: ['Christian', 'Pierre-Emile', 'Kasper', 'Simon', 'Andreas', 'Joachim', 'Mikkel', 'Jonas', 'Thomas', 'Martin', 'Michael', 'Brian', 'Peter', 'Jon', 'Daniel', 'Jens', 'Lars', 'Søren', 'Morten', 'Jørgen', 'Niels', 'Henrik', 'Poul', 'Hans', 'Ole', 'Erik', 'Per', 'Mads', 'Emil', 'Oliver', 'Victor', 'Noah', 'William', 'Lucas', 'Carl', 'Malthe', 'Valdemar', 'Frederik', 'Christian', 'August'],
  BE: ['Kevin', 'Romelu', 'Thibaut', 'Eden', 'Jan', 'Toby', 'Vincent', 'Dries', 'Axel', 'Youri', 'Amadou', 'Leandro', 'Jeremy', 'Yannick', 'Marc', 'Michel', 'Enzo', 'Paul', 'Jean', 'Pierre', 'Luc', 'Dirk', 'Johan', 'Bart', 'Tom', 'Wouter', 'Jelle', 'Arthur', 'Liam', 'Noah', 'Lucas', 'Louis', 'Jules', 'Victor', 'Leon', 'Mathis', 'Gabriel', 'Hugo', 'Maxime', 'Thomas'],
  CH: ['Granit', 'Xherdan', 'Yann', 'Manuel', 'Breel', 'Denis', 'Fabian', 'Ricardo', 'Nico', 'Remo', 'Stephan', 'Alexander', 'Haris', 'Valon', 'Blerim', 'Gökhan', 'Eren', 'Johan', 'Tranquillo', 'Hakan', 'Noah', 'Leon', 'Luca', 'Loris', 'Matteo', 'David', 'Elias', 'Julian', 'Gabriel', 'Samuel', 'Simon', 'Daniel', 'Michael', 'Thomas', 'Martin', 'Peter', 'Hans', 'Urs', 'Christian', 'Stefan'],
  CO: ['James', 'Radamel', 'Luis', 'Juan', 'David', 'Yerry', 'Davinson', 'Jefferson', 'Mateus', 'Wílmar', 'Carlos', 'Freddy', 'René', 'Faustino', 'Leonel', 'Iván', 'Mario', 'Víctor', 'Miguel', 'Camilo', 'Santiago', 'Sebastián', 'Alejandro', 'Daniel', 'Andrés', 'Diego', 'Felipe', 'Julián', 'Mateo', 'Nicolás', 'Samuel', 'Martín', 'Jerónimo', 'Emiliano', 'Maximiliano', 'Tomás', 'Matías', 'Juan', 'José', 'Pedro'],
  MA: ['Achraf', 'Hakim', 'Yassine', 'Sofyan', 'Romain', 'Nayef', 'Azzedine', 'Youssef', 'Sofiane', 'Amine', 'Mustapha', 'Noureddine', 'Salaheddine', 'Mehdi', 'Tarik', 'Baddou', 'Aziz', 'Hassan', 'Rachid', 'Khalid', 'Mohammed', 'Amine', 'Ayoub', 'Hamza', 'Yassine', 'Mehdi', 'Omar', 'Anas', 'Ilyass', 'Zakaria', 'Ismail', 'Ibrahim', 'Abdel', 'Ali', 'Othmane', 'Saad', 'Hicham', 'Younes', 'Walid', 'Karim'],
  NG: ['Victor', 'Alex', 'Wilfred', 'Kelechi', 'Ahmed', 'Samuel', 'Joe', 'Leon', 'William', 'Kenneth', 'Nwankwo', 'Jay-Jay', 'Taribo', 'Sunday', 'Finidi', 'Rashidi', 'Vincent', 'Obafemi', 'John', 'Peter', 'Emmanuel', 'David', 'Daniel', 'Michael', 'Joseph', 'Anthony', 'Paul', 'Mark', 'James', 'Kingsley', 'Chinedu', 'Emeka', 'Chuks', 'Uchenna', 'Ifeanyi', 'Obinna', 'Chigozie', 'Nnamdi', 'Chibuzor', 'Chidiebere'],
  ZA: ['Percy', 'Ronwen', 'Themba', 'Khama', 'Keagan', 'Mothobi', 'Siyanda', 'Itumeleng', 'Thulani', 'Teboho', 'Benni', 'Lucas', 'Aaron', 'Doctor', 'Mark', 'Shaun', 'Siyabonga', 'Teko', 'Siphiwe', 'Itumeleng', 'Thabo', 'Sipho', 'Bongani', 'Sibusiso', 'Mpho', 'Kagiso', 'Tshepo', 'Lesego', 'Karabo', 'Tumelo', 'Katlego', 'Olebogeng', 'Lebogang', 'Njabulo', 'Sanele', 'Ayanda', 'Wandile', 'Bandile', 'Lunga', 'Siyabonga'],
};


export const FIRST_NAMES_FEMALE = {
  FR: ['Wendie', 'Kadidiatou', 'Grace', 'Sakina', 'Eugénie', 'Amandine', 'Delphine', 'Marie-Antoinette', 'Sandy', 'Kenza', 'Selma', 'Elisa', 'Maëlle', 'Camille', 'Clara', 'Chloé', 'Léa', 'Manon', 'Juliette', 'Louise', 'Emma', 'Jade', 'Alice', 'Lina', 'Rose', 'Mila', 'Ambre', 'Anna', 'Julia', 'Mia', 'Lou', 'Inès', 'Sarah', 'Nina', 'Lola', 'Zoé', 'Eva', 'Léonie', 'Jeanne', 'Victoria'],
  EN: ['Leah', 'Mary', 'Lucy', 'Keira', 'Chloe', 'Georgia', 'Alessia', 'Beth', 'Ella', 'Lauren', 'Fran', 'Steph', 'Millie', 'Rachel', 'Alex', 'Ellen', 'Jill', 'Karen', 'Fara', 'Kelly', 'Olivia', 'Amelia', 'Isla', 'Ava', 'Mia', 'Isabella', 'Sophia', 'Grace', 'Lily', 'Freya', 'Evie', 'Florence', 'Willow', 'Poppy', 'Rosie', 'Daisy', 'Ruby', 'Evelyn', 'Sienna', 'Phoebe'],
  ES: ['Alexia', 'Aitana', 'Jennifer', 'Irene', 'Mapi', 'Patri', 'Mariona', 'Salma', 'Ona', 'Olga', 'Cata', 'Esther', 'Alba', 'Laia', 'Lucía', 'Martina', 'Sofía', 'María', 'Valeria', 'Julia', 'Paula', 'Emma', 'Daniela', 'Carla', 'Alba', 'Noa', 'Carmen', 'Claudia', 'Valentina', 'Alma', 'Ana', 'Laura', 'Marta', 'Cristina', 'Sara', 'Elena', 'Rocío', 'Teresa', 'Raquel', 'Beatriz'],
  IT: ['Cristiana', 'Barbara', 'Sara', 'Laura', 'Valentina', 'Manuela', 'Martina', 'Elena', 'Arianna', 'Lisa', 'Sofia', 'Aurora', 'Giulia', 'Ginevra', 'Alice', 'Beatrice', 'Emma', 'Giorgia', 'Vittoria', 'Matilde', 'Greta', 'Martina', 'Chiara', 'Anna', 'Ludovica', 'Nicole', 'Francesca', 'Ginevra', 'Camilla', 'Bianca', 'Alessia', 'Elisa', 'Noemi', 'Eleonora', 'Giada', 'Miriam', 'Gaia', 'Ginevra', 'Ilaria', 'Federica'],
  DE: ['Alexandra', 'Lena', 'Dzsenifer', 'Melanie', 'Svenja', 'Lea', 'Giulia', 'Klara', 'Merle', 'Sydney', 'Birgit', 'Nadine', 'Silvia', 'Martina', 'Bettina', 'Mia', 'Emma', 'Sofia', 'Hannah', 'Emilia', 'Anna', 'Lina', 'Mila', 'Lea', 'Marie', 'Lena', 'Luisa', 'Clara', 'Amelie', 'Johanna', 'Mathilda', 'Lara', 'Nele', 'Sophie', 'Lilly', 'Charlotte', 'Ida', 'Leni', 'Frieda', 'Emily'],
  BR: ['Marta', 'Cristiane', 'Formiga', 'Debinha', 'Bia', 'Tamires', 'Ludmila', 'Ary', 'Gabi', 'Letícia', 'Rafaelle', 'Antônia', 'Kerolin', 'Luana', 'Nycole', 'Helena', 'Alice', 'Laura', 'Manuela', 'Sophia', 'Isabella', 'Luísa', 'Heloísa', 'Cecília', 'Maitê', 'Júlia', 'Antonella', 'Giovanna', 'Maria', 'Lorena', 'Lívia', 'Marina', 'Clara', 'Isadora', 'Beatriz', 'Valentina', 'Melissa', 'Yasmin', 'Eduarda', 'Catarina'],
  AR: ['Estefanía', 'Mariana', 'Florencia', 'Aldana', 'Ruth', 'Miriam', 'Sole', 'Eliana', 'Yamila', 'Dalila', 'Vanina', 'Amancay', 'Belen', 'Camila', 'Catalina', 'Martina', 'Isabella', 'Catalina', 'Valentina', 'Emma', 'Sofía', 'Olivia', 'Delfina', 'Renata', 'Mía', 'Bautista', 'Alma', 'Zoe', 'Emilia', 'Victoria', 'Juana', 'Lola', 'Guadalupe', 'Candela', 'Pilar', 'Jazmín', 'Milagros', 'Julieta', 'Luciana', 'Agustina'],
  NL: ['Vivianne', 'Lieke', 'Danielle', 'Jackie', 'Sherida', 'Sari', 'Jill', 'Lineth', 'Dominique', 'Merel', 'Daniëlle', 'Stefanie', 'Anouk', 'Mandy', 'Daphne', 'Emma', 'Mila', 'Julia', 'Zoe', 'Tess', 'Sophie', 'Sara', 'Yara', 'Nora', 'Lotte', 'Eva', 'Liv', 'Fleur', 'Lynn', 'Elin', 'Anna', 'Isa', 'Roos', 'Maud', 'Fien', 'Saar', 'Lieke', 'Noa', 'Nina', 'Loes'],
  PT: ['Jéssica', 'Ana', 'Tatiana', 'Diana', 'Cláudia', 'Dolores', 'Carole', 'Kika', 'Andreia', 'Telma', 'Sílvia', 'Mónica', 'Carla', 'Maria', 'Leonor', 'Matilde', 'Beatriz', 'Carolina', 'Mariana', 'Inês', 'Margarida', 'Sofia', 'Lara', 'Alice', 'Francisca', 'Clara', 'Madalena', 'Diana', 'Joana', 'Catarina', 'Mafalda', 'Íris', 'Eva', 'Constança', 'Marta', 'Bianca', 'Camila', 'Luísa', 'Vitória', 'Laura'],
  US: ['Alex', 'Megan', 'Rose', 'Lindsey', 'Kelley', 'Crystal', 'Tobin', 'Julie', 'Christen', 'Alyssa', 'Mia', 'Abby', 'Hope', 'Carli', 'Michelle', 'Sophia', 'Olivia', 'Emma', 'Ava', 'Isabella', 'Mia', 'Charlotte', 'Amelia', 'Harper', 'Evelyn', 'Abigail', 'Emily', 'Elizabeth', 'Avery', 'Sofia', 'Ella', 'Madison', 'Scarlett', 'Victoria', 'Aria', 'Grace', 'Chloe', 'Camila', 'Penelope', 'Riley'],
  JP: ['Saki', 'Mana', 'Homare', 'Aya', 'Yuki', 'Nahomi', 'Kumi', 'Rumi', 'Mizuho', 'Nadeshiko', 'Hina', 'Yui', 'Sakura', 'Ichika', 'Akari', 'Aoi', 'Himari', 'Rio', 'Kokoro', 'Kanna', 'Mei', 'Honoka', 'Yuna', 'Mio', 'Rin', 'Sara', 'Haruna', 'Saki', 'Natsuki', 'Ayane', 'Miku', 'Rika', 'Yuka', 'Ayaka', 'Erika', 'Sayaka', 'Haruka', 'Chihiro', 'Misaki', 'Yoko'],
  SE: ['Kosovare', 'Caroline', 'Stina', 'Magdalena', 'Nilla', 'Hedvig', 'Fridolina', 'Lotta', 'Hanna', 'Sofia', 'Pia', 'Therese', 'Victoria', 'Emma', 'Alice', 'Maja', 'Elsa', 'Astrid', 'Wilma', 'Freja', 'Olivia', 'Ebba', 'Klara', 'Stella', 'Agnes', 'Ella', 'Elin', 'Ida', 'Alva', 'Vera', 'Nova', 'Saga', 'Signe', 'Julia', 'Lova', 'Isabella', 'Selma', 'Linnea', 'Amanda', 'Hanna'],
  NO: ['Ada', 'Caroline', 'Guro', 'Maren', 'Ingrid', 'Frida', 'Emilie', 'Tuva', 'Vilde', 'Lisa', 'Hege', 'Solveig', 'Linda', 'Nina', 'Nora', 'Emma', 'Olivia', 'Sofie', 'Emilie', 'Lea', 'Sofia', 'Sara', 'Amalie', 'Ingrid', 'Thea', 'Ida', 'Mia', 'Maja', 'Tiril', 'Mathilde', 'Frida', 'Jenny', 'Anna', 'Julie', 'Linnea', 'Aurora', 'Selma', 'Vilde', 'Astrid', 'Oda'],
  DK: ['Pernille', 'Sanne', 'Nadia', 'Katrine', 'Theresa', 'Stine', 'Sofie', 'Line', 'Frederikke', 'Janni', 'Alma', 'Agnes', 'Ella', 'Freja', 'Clara', 'Emma', 'Sofia', 'Ida', 'Anna', 'Olivia', 'Laura', 'Josefine', 'Mathilde', 'Isabella', 'Alberte', 'Naja', 'Karla', 'Maja', 'Lærke', 'Victoria', 'Aya', 'Liva', 'Johanne', 'Caroline', 'Emilie', 'Rosa', 'Mille', 'Esther', 'Signe', 'Sara'],
  BE: ['Tessa', 'Janice', 'Davina', 'Tine', 'Justine', 'Laura', 'Kassandra', 'Chloe', 'Maud', 'Sarah', 'Olivia', 'Emma', 'Louise', 'Mila', 'Alice', 'Camille', 'Juliette', 'Sofia', 'Lina', 'Elena', 'Mia', 'Anna', 'Julia', 'Marie', 'Lucie', 'Nina', 'Margaux', 'Nora', 'Clara', 'Amélie', 'Elise', 'Charlotte', 'Lotte', 'Noor', 'Hanne', 'Julie', 'Fien', 'Ella', 'Emma', 'Roos'],
  CH: ['Ramona', 'Lia', 'Ana-Maria', 'Coumba', 'Géraldine', 'Gaëlle', 'Noelle', 'Rachel', 'Malin', 'Fabienne', 'Mia', 'Alina', 'Emma', 'Lina', 'Elena', 'Laura', 'Sofia', 'Nina', 'Mila', 'Lara', 'Anna', 'Lea', 'Julia', 'Sara', 'Luisa', 'Melina', 'Sophia', 'Emilia', 'Leonor', 'Amelie', 'Chiara', 'Nora', 'Aurora', 'Elisa', 'Alessia', 'Valentina', 'Alice', 'Giulia', 'Martina', 'Isabella'],
  CO: ['Linda', 'Catalina', 'Daniela', 'Mayra', 'Leicy', 'Lady', 'Carolina', 'Diana', 'Yoreli', 'Sandra', 'Valentina', 'Mariana', 'Luciana', 'Isabella', 'Salomé', 'Antonella', 'Camila', 'Gabriela', 'Valeria', 'Sofía', 'María', 'Sara', 'Juliana', 'Laura', 'Ana', 'Manuela', 'Daniela', 'Paula', 'Andrea', 'Alejandra', 'Natalia', 'Victoria', 'Emilia', 'Samantha', 'Génesis', 'Antonia', 'Martina', 'Julieta', 'Celeste', 'Mía'],
  MA: ['Ghizlane', 'Rosella', 'Salma', 'Khadija', 'Nouhaila', 'Ibtissam', 'Sanaä', 'Hanane', 'Najat', 'Meryem', 'Fatima', 'Aya', 'Nour', 'Malak', 'Mariam', 'Yasmina', 'Leila', 'Inès', 'Lina', 'Amira', 'Zineb', 'Hiba', 'Rania', 'Salma', 'Chaima', 'Oumaima', 'Nada', 'Asma', 'Wissal', 'Hind', 'Bouchra', 'Saida', 'Hafida', 'Karima', 'Samira', 'Latifa', 'Hakima', 'Souad', 'Naima', 'Kawtar'],
  NG: ['Asisat', 'Rasheedat', 'Desire', 'Onome', 'Francisca', 'Ngozi', 'Rita', 'Uchenna', 'Joy', 'Halimatu', 'Blessing', 'Mercy', 'Faith', 'Peace', 'Glory', 'Praise', 'Grace', 'Mary', 'Esther', 'Sarah', 'Ruth', 'Joy', 'Precious', 'Destiny', 'Miracle', 'Favour', 'Gift', 'Promise', 'Goodness', 'Hope', 'Charity', 'Patience', 'Oluwakemi', 'Adeola', 'Chidinma', 'Amaka', 'Nneka', 'Ogechi', 'Chinyere', 'Ijeoma'],
  ZA: ['Thembi', 'Refiloe', 'Janine', 'Noko', 'Andile', 'Jermaine', 'Linda', 'Bambanani', 'Lebohang', 'Hilda', 'Thando', 'Nandi', 'Zanele', 'Lindiwe', 'Lerato', 'Nomsa', 'Buhle', 'Sipho', 'Amahle', 'Mbali', 'Precious', 'Princess', 'Beauty', 'Sizwe', 'Thato', 'Karabo', 'Lethabo', 'Lesedi', 'Tshegofatso', 'Keneilwe', 'Boitumelo', 'Keletso', 'Tebogo', 'Kagiso', 'Dineo', 'Nthabiseng', 'Refilwe', 'Koketso', 'Kamogelo', 'Olebogeng'],
};

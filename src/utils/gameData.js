...
export const FIRST_NAMES_MALE = {
  FR: ['Hugo', 'Thomas', 'Mathis', 'Maxime', 'Lucas', 'Théo', 'Benjamin', 'Jules', 'Arthur', 'Romain', 'Adrien', 'William', 'Paul', 'Pierre', 'Enzo', 'Nathan', 'Tom', 'Louis', 'Gabriel', 'Maël', 'Liam', 'Ethan', 'Victor', 'Clément'],
  EN: ['Harry', 'Oliver', 'George', 'William', 'Charlie', 'Thomas', 'Henry', 'Arthur', 'Leo', 'Oscar', 'Noah', 'Jack', 'Mason', 'Ben', 'Aaron', 'Conor', 'Cole', 'Ollie', 'James', 'Edward', 'Charles', 'Joseph'],
  ES: ['Alvaro', 'David', 'Sergio', 'Antonio', 'Francisco', 'Manuel', 'Javier', 'Alejandro', 'Carlos', 'Diego', 'Jorge', 'Mario', 'Pablo', 'Adrián', 'Hugo', 'Martín', 'Lucas', 'Mateo', 'Leo', 'Daniel', 'Jose', 'Ruben'],
  IT: ['Alessandro', 'Lorenzo', 'Marco', 'Francesco', 'Leonardo', 'Giovanni', 'Andrea', 'Giorgio', 'Giacomo', 'Mattia', 'Matteo', 'Riccardo', 'Emanuele', 'Domenico', 'Vincenzo', 'Antonio', 'Roberto', 'Paolo', 'Christian', 'Stefano', 'Luigi', 'Pietro', 'Davide', 'Filippo', 'Tommaso', 'Edoardo', 'Samuele', 'Alessio', 'Gabriele', 'Daniele', 'Massimo', 'Angelo', 'Carmine', 'Rosario'],
  DE: ['Manuel', 'Thomas', 'Leon', 'Florian', 'Alexander', 'Paul', 'Elias', 'Ben', 'Luis', 'Felix', 'Noah', 'Finn', 'Lukas', 'Michael', 'Oliver', 'Karl', 'Hans', 'Jürgen', 'Dieter', 'Klaus', 'Uwe', 'Jens', 'Stefan', 'Andreas', 'Christian', 'Markus', 'Maximilian'],
  BR: ['Gabriel', 'Lucas', 'Bruno', 'Arthur', 'Pedro', 'João', 'Miguel', 'Davi', 'Bernardo', 'Heitor', 'Rafael', 'Guilherme', 'Gustavo', 'Felipe', 'Matheus', 'Enzo', 'Nicolas', 'Daniel', 'Carlos', 'Eduardo', 'Diego', 'Alexandre', 'Marcelo'],
  AR: ['Emiliano', 'Enzo', 'Alexis', 'Nicolas', 'Nahuel', 'Gonzalo', 'Sergio', 'Diego', 'Javier', 'Juan', 'Carlos', 'Pablo', 'Matias', 'Facundo', 'Bautista', 'Mateo', 'Benjamín', 'Joaquín', 'Tomás', 'Santino', 'Valentino', 'Ignacio', 'Felipe', 'Lucas', 'Martín', 'Marcos', 'Franco', 'Ezequiel', 'Maximiliano', 'Sebastián', 'Alejandro', 'Marcelo', 'Gaston'],
  NL: ['Daan', 'Bram', 'Thijs', 'Milan', 'Lars', 'Finn', 'Levi', 'Jesse', 'Sven', 'Tim', 'Ruben', 'Nils', 'Pim', 'Bas', 'Casper', 'Stijn', 'Jeroen', 'Koen', 'Sem', 'Luuk'],
  PT: ['João', 'Diogo', 'Rafael', 'Nuno', 'Gonçalo', 'Pedro', 'Francisco', 'António', 'Rui', 'Luis', 'Ricardo', 'Tiago', 'Tomás', 'Martim', 'Rodrigo', 'Afonso', 'Duarte', 'Miguel', 'Gabriel', 'Guilherme', 'Simão', 'Henrique', 'José', 'Manuel', 'Carlos', 'Jorge', 'Paulo', 'Fernando', 'Mário', 'André', 'Hugo', 'Daniel'],
  US: ['William', 'Robert', 'David', 'Richard', 'Joseph', 'Charles', 'Thomas', 'Christopher', 'Daniel', 'Matthew', 'Anthony', 'Mark', 'Donald', 'Steven', 'Paul', 'Andrew', 'Kenneth', 'Joshua', 'Kevin', 'Brian', 'George', 'Edward', 'James', 'John', 'Michael'],
  JP: ['Takefusa', 'Kaoru', 'Wataru', 'Daichi', 'Takehiro', 'Ritsu', 'Junya', 'Ao', 'Takumi', 'Yuto', 'Maya', 'Shinji', 'Keisuke', 'Hidetoshi', 'Kazuyoshi', 'Shunsuke', 'Makoto', 'Eiji', 'Haruto', 'Yuto', 'Sota', 'Yuki', 'Hayato', 'Ren', 'Minato', 'Hiroto', 'Sora', 'Riku', 'Kaito', 'Sho', 'Taiga', 'Itsuki', 'Kenji', 'Taro', 'Ichiro', 'Jiro', 'Saburo', 'Shiro'],
  SE: ['Alexander', 'Emil', 'Victor', 'Jesper', 'Mattias', 'Robin', 'Sebastian', 'Carl', 'Henrik', 'Fredrik', 'Johan', 'Anders', 'Mikael', 'Daniel', 'Per', 'Karl', 'Erik', 'Lars', 'Olof', 'Gunnar', 'Nils', 'Sven', 'Björn', 'Magnus', 'Oskar', 'William', 'Lucas', 'Liam', 'Elias', 'Hugo', 'Oliver', 'Theo', 'Isak', 'Arvid', 'August', 'Albin', 'Ludvig'],
  NO: ['Martin', 'Alexander', 'Sander', 'Kristoffer', 'Jens', 'Leo', 'Mathias', 'Fredrik', 'Ole', 'Tore', 'Henning', 'John', 'Brede', 'Kjetil', 'Jan', 'Erik', 'Bjørn', 'Lars', 'Kjell', 'Svein', 'Knut', 'Arne', 'Geir', 'Morten', 'Rune', 'Terje', 'Odd', 'Roar', 'Jakob', 'Emil', 'Noah', 'Oliver', 'William', 'Filip', 'Aksel', 'Henrik', 'Oskar', 'Elias'],
  DK: ['Christian', 'Kasper', 'Simon', 'Andreas', 'Joachim', 'Mikkel', 'Jonas', 'Thomas', 'Martin', 'Michael', 'Brian', 'Peter', 'Jon', 'Daniel', 'Jens', 'Lars', 'Søren', 'Morten', 'Jørgen', 'Niels', 'Henrik', 'Poul', 'Hans', 'Ole', 'Erik', 'Per', 'Mads', 'Emil', 'Oliver', 'Victor', 'Noah', 'William', 'Lucas', 'Carl', 'Malthe', 'Valdemar', 'Frederik', 'August'],
  ...
  CH: ['Yann', 'Manuel', 'Denis', 'Fabian', 'Ricardo', 'Nico', 'Remo', 'Stephan', 'Alexander', 'Haris', 'Valon', 'Blerim', 'Gökhan', 'Eren', 'Johan', 'Tranquillo', 'Hakan', 'Noah', 'Leon', 'Luca', 'Loris', 'Matteo', 'David', 'Elias', 'Julian', 'Gabriel', 'Samuel', 'Simon', 'Daniel', 'Michael', 'Thomas', 'Martin', 'Peter', 'Hans', 'Urs', 'Christian', 'Stefan'],
  CO: ['James', 'Radamel', 'Luis', 'Juan', 'David', 'Yerry', 'Davinson', 'Jefferson', 'Mateus', 'Wílmar', 'Carlos', 'Freddy', 'René', 'Faustino', 'Leonel', 'Iván', 'Mario', 'Víctor', 'Miguel', 'Camilo', 'Santiago', 'Sebastián', 'Alejandro', 'Daniel', 'Andrés', 'Diego', 'Felipe', 'Julián', 'Mateo', 'Nicolás', 'Samuel', 'Martín', 'Jerónimo', 'Emiliano', 'Maximiliano', 'Tomás', 'Matías', 'José', 'Pedro'],
  MA: ['Achraf', 'Hakim', 'Yassine', 'Sofyan', 'Romain', 'Nayef', 'Azzedine', 'Youssef', 'Sofiane', 'Amine', 'Mustapha', 'Noureddine', 'Salaheddine', 'Mehdi', 'Tarik', 'Baddou', 'Aziz', 'Hassan', 'Rachid', 'Khalid', 'Mohammed', 'Ayoub', 'Hamza', 'Omar', 'Anas', 'Ilyass', 'Zakaria', 'Ismail', 'Ibrahim', 'Abdel', 'Ali', 'Othmane', 'Saad', 'Hicham', 'Younes', 'Walid', 'Karim'],
  ...
  ZA: ['Percy', 'Ronwen', 'Themba', 'Khama', 'Keagan', 'Mothobi', 'Siyanda', 'Itumeleng', 'Thulani', 'Teboho', 'Benni', 'Lucas', 'Aaron', 'Doctor', 'Mark', 'Shaun', 'Siyabonga', 'Teko', 'Siphiwe', 'Thabo', 'Sipho', 'Bongani', 'Sibusiso', 'Mpho', 'Kagiso', 'Tshepo', 'Lesego', 'Karabo', 'Tumelo', 'Katlego', 'Olebogeng', 'Lebogang', 'Njabulo', 'Sanele', 'Ayanda', 'Wandile', 'Bandile', 'Lunga']
};


export const FIRST_NAMES_FEMALE = {
  FR: ['Camille', 'Clara', 'Chloé', 'Léa', 'Manon', 'Juliette', 'Louise', 'Emma', 'Jade', 'Alice', 'Lina', 'Rose', 'Mila', 'Ambre', 'Anna', 'Julia', 'Mia', 'Lou', 'Inès', 'Sarah', 'Nina', 'Lola', 'Zoé', 'Eva', 'Léonie', 'Jeanne', 'Victoria'],
  EN: ['Chloe', 'Georgia', 'Ella', 'Lauren', 'Olivia', 'Amelia', 'Isla', 'Ava', 'Mia', 'Isabella', 'Sophia', 'Grace', 'Lily', 'Freya', 'Evie', 'Florence', 'Willow', 'Poppy', 'Rosie', 'Daisy', 'Ruby', 'Evelyn', 'Sienna', 'Phoebe'],
  ES: ['Lucía', 'Martina', 'Sofía', 'María', 'Valeria', 'Julia', 'Paula', 'Emma', 'Daniela', 'Carla', 'Alba', 'Noa', 'Carmen', 'Claudia', 'Valentina', 'Alma', 'Ana', 'Laura', 'Marta', 'Cristina', 'Sara', 'Elena', 'Rocío', 'Teresa', 'Raquel', 'Beatriz'],
  IT: ['Sofia', 'Aurora', 'Giulia', 'Ginevra', 'Alice', 'Beatrice', 'Emma', 'Giorgia', 'Vittoria', 'Matilde', 'Greta', 'Martina', 'Chiara', 'Anna', 'Ludovica', 'Nicole', 'Francesca', 'Camilla', 'Bianca', 'Alessia', 'Elisa', 'Noemi', 'Eleonora', 'Giada', 'Miriam', 'Gaia', 'Ilaria', 'Federica'],
  DE: ['Mia', 'Emma', 'Sofia', 'Hannah', 'Emilia', 'Anna', 'Lina', 'Mila', 'Lea', 'Marie', 'Lena', 'Luisa', 'Clara', 'Amelie', 'Johanna', 'Mathilda', 'Lara', 'Nele', 'Sophie', 'Lilly', 'Charlotte', 'Ida', 'Leni', 'Frieda', 'Emily'],
  BR: ['Helena', 'Alice', 'Laura', 'Manuela', 'Sophia', 'Isabella', 'Luísa', 'Heloísa', 'Cecília', 'Maitê', 'Júlia', 'Antonella', 'Giovanna', 'Maria', 'Lorena', 'Lívia', 'Marina', 'Clara', 'Isadora', 'Beatriz', 'Valentina', 'Melissa', 'Yasmin', 'Eduarda', 'Catarina'],
  AR: ['Martina', 'Isabella', 'Catalina', 'Valentina', 'Emma', 'Sofía', 'Olivia', 'Delfina', 'Renata', 'Mía', 'Alma', 'Zoe', 'Emilia', 'Victoria', 'Juana', 'Lola', 'Guadalupe', 'Candela', 'Pilar', 'Jazmín', 'Milagros', 'Julieta', 'Luciana', 'Agustina'],
  NL: ['Emma', 'Mila', 'Julia', 'Zoe', 'Tess', 'Sophie', 'Sara', 'Yara', 'Nora', 'Lotte', 'Eva', 'Liv', 'Fleur', 'Lynn', 'Elin', 'Anna', 'Isa', 'Roos', 'Maud', 'Fien', 'Saar', 'Lieke', 'Noa', 'Nina', 'Loes'],
  PT: ['Maria', 'Leonor', 'Matilde', 'Beatriz', 'Carolina', 'Mariana', 'Inês', 'Margarida', 'Sofia', 'Lara', 'Alice', 'Francisca', 'Clara', 'Madalena', 'Diana', 'Joana', 'Catarina', 'Mafalda', 'Íris', 'Eva', 'Constança', 'Marta', 'Bianca', 'Camila', 'Luísa', 'Vitória', 'Laura'],
  US: ['Olivia', 'Emma', 'Ava', 'Isabella', 'Mia', 'Charlotte', 'Amelia', 'Harper', 'Evelyn', 'Abigail', 'Emily', 'Elizabeth', 'Avery', 'Sofia', 'Ella', 'Madison', 'Scarlett', 'Victoria', 'Aria', 'Grace', 'Chloe', 'Camila', 'Penelope', 'Riley'],
  JP: ['Sakura', 'Ichika', 'Akari', 'Aoi', 'Himari', 'Rio', 'Kokoro', 'Kanna', 'Mei', 'Honoka', 'Yuna', 'Mio', 'Rin', 'Sara', 'Haruna', 'Saki', 'Natsuki', 'Ayane', 'Miku', 'Rika', 'Yuka', 'Ayaka', 'Erika', 'Sayaka', 'Haruka', 'Chihiro', 'Misaki', 'Yoko'],
  SE: ['Alice', 'Maja', 'Elsa', 'Astrid', 'Wilma', 'Freja', 'Olivia', 'Ebba', 'Klara', 'Stella', 'Agnes', 'Ella', 'Elin', 'Ida', 'Alva', 'Vera', 'Nova', 'Saga', 'Signe', 'Julia', 'Lova', 'Isabella', 'Selma', 'Linnea', 'Amanda', 'Hanna'],
  NO: ['Nora', 'Emma', 'Olivia', 'Sofie', 'Emilie', 'Lea', 'Sofia', 'Sara', 'Amalie', 'Ingrid', 'Thea', 'Ida', 'Mia', 'Maja', 'Tiril', 'Mathilde', 'Frida', 'Jenny', 'Anna', 'Julie', 'Linnea', 'Aurora', 'Selma', 'Vilde', 'Astrid', 'Oda'],
  DK: ['Alma', 'Agnes', 'Ella', 'Freja', 'Clara', 'Emma', 'Sofia', 'Ida', 'Anna', 'Olivia', 'Laura', 'Josefine', 'Mathilde', 'Isabella', 'Alberte', 'Naja', 'Karla', 'Maja', 'Lærke', 'Victoria', 'Aya', 'Liva', 'Johanne', 'Caroline', 'Emilie', 'Rosa', 'Mille', 'Esther', 'Signe', 'Sara'],
  BE: ['Olivia', 'Emma', 'Louise', 'Mila', 'Alice', 'Camille', 'Juliette', 'Sofia', 'Lina', 'Elena', 'Mia', 'Anna', 'Julia', 'Marie', 'Lucie', 'Nina', 'Margaux', 'Nora', 'Clara', 'Amélie', 'Elise', 'Charlotte', 'Lotte', 'Noor', 'Hanne', 'Julie', 'Fien', 'Ella', 'Emma', 'Roos'],
  CH: ['Mia', 'Alina', 'Emma', 'Lina', 'Elena', 'Laura', 'Sofia', 'Nina', 'Mila', 'Lara', 'Anna', 'Lea', 'Julia', 'Sara', 'Luisa', 'Melina', 'Sophia', 'Emilia', 'Leonor', 'Amelie', 'Chiara', 'Nora', 'Aurora', 'Elisa', 'Alessia', 'Valentina', 'Alice', 'Giulia', 'Martina', 'Isabella'],
  CO: ['Luciana', 'Isabella', 'Salomé', 'Antonella', 'Camila', 'Gabriela', 'Valeria', 'Sofía', 'María', 'Sara', 'Juliana', 'Laura', 'Ana', 'Manuela', 'Daniela', 'Paula', 'Andrea', 'Alejandra', 'Natalia', 'Victoria', 'Emilia', 'Samantha', 'Génesis', 'Antonia', 'Martina', 'Julieta', 'Celeste', 'Mía'],
  MA: ['Aya', 'Nour', 'Malak', 'Mariam', 'Yasmina', 'Leila', 'Inès', 'Lina', 'Amira', 'Zineb', 'Hiba', 'Rania', 'Salma', 'Chaima', 'Oumaima', 'Nada', 'Asma', 'Wissal', 'Hind', 'Bouchra', 'Saida', 'Hafida', 'Karima', 'Samira', 'Latifa', 'Hakima', 'Souad', 'Naima', 'Kawtar'],
  NG: ['Grace', 'Mary', 'Esther', 'Sarah', 'Ruth', 'Joy', 'Precious', 'Destiny', 'Miracle', 'Favour', 'Gift', 'Promise', 'Goodness', 'Hope', 'Charity', 'Patience', 'Oluwakemi', 'Adeola', 'Chidinma', 'Amaka', 'Nneka', 'Ogechi', 'Chinyere', 'Ijeoma'],
  ZA: ['Amahle', 'Mbali', 'Precious', 'Princess', 'Beauty', 'Sizwe', 'Thato', 'Karabo', 'Lethabo', 'Lesedi', 'Tshegofatso', 'Keneilwe', 'Boitumelo', 'Keletso', 'Tebogo', 'Kagiso', 'Dineo', 'Nthabiseng', 'Refilwe', 'Koketso', 'Kamogelo', 'Olebogeng']
};
